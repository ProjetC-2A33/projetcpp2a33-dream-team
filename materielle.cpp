...
Materielle::MaterielData Materielle::getMaterielById(const QString &idMateriel)
{
    ...
    QSqlQuery query;
    query.prepare("SELECT IDMATERIEL, ETAT_MATERIEL, LOCALISATION, DATE_ACHAT, NB_MATERIEL, TYPE_MATERIEL, SUIVI FROM " + tableName + " WHERE IDMATERIEL = :id");
...
bool Materielle::ajouter(const MaterielData &data, QWidget *parent)
{
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO " + tableName + " (IDMATERIEL, ETAT_MATERIEL, LOCALISATION, DATE_ACHAT, NB_MATERIEL, TYPE_MATERIEL, SUIVI) "
...
bool Materielle::modifier(const QString &oldId, const MaterielData &data, QWidget *parent)
{
    ...
    // Update database
    QSqlQuery query;
    query.prepare("UPDATE " + tableName + " SET IDMATERIEL = :id, ETAT_MATERIEL = :etat, LOCALISATION = :localisation, "
...
bool Materielle::lire(QTableWidget *tableWidget, QWidget *parent)
{
    ...
    QSqlQuery query;
    query.prepare("SELECT IDMATERIEL, ETAT_MATERIEL, LOCALISATION, DATE_ACHAT, NB_MATERIEL, TYPE_MATERIEL, SUIVI FROM " + tableName + " ORDER BY IDMATERIEL");
