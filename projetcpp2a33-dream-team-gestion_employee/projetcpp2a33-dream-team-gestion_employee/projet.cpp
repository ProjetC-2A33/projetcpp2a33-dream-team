...
bool Projet::exportTableToPdf(QTableWidget* table, const QString& filePath) {
   /* if (!table) {
    ...
    try {
        ...
        painter.drawText(QRectF(margin, currentY, pageWidth, 28), Qt::AlignLeft | Qt::AlignVCenter, "Gestion De Projet");
        currentY += 38;
        ...
        for (int col = 0; col < colCount; ++col) {
            ...
            painter.drawText(QRectF(x + 6, currentY, colWidths[col] - 12, headerHeight),
        ...
        for (int row = 0; row < rowCount; ++row) {
            ...
            for (int col = 0; col < colCount; ++col) {
                ...
                painter.drawText(QRectF(x2 + 6, currentY, colWidths[col] - 12, rowHeight),
        ...
        s_lastError = "Erreur lors de la création du PDF";
        return false;
    }*/
}
