...
""));
        ...
        pushButton_61->setGeometry(QRect(1100, 630, 131, 41));
...
""));
        ...
        tableView->setGeometry(QRect(440, 230, 781, 381));
...
"   "
                        " background: #5555FF;\n"
"}"));
        label_platform = new QLabel(groupBox_2);
        label_platform->setObjectName("label_platform");
        label_platform->setGeometry(QRect(520, 640, 211, 20));
        label_4->raise();
        label_2->raise();
        comboBox_2->raise();
        groupBox_12->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_platform->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
    } // retranslateUi
