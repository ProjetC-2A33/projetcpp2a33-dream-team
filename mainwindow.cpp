    ...
    , ui(new Ui::MainWindow)
{
    ...
    if (ui->pushButton_stat)
    {
        connect(ui->pushButton_stat, &QPushButton::clicked,
                this, &MainWindow::on_pushButton_stat_clicked);
    }
...
// ---------------------- RECHERCHE PAR ID ----------------------
void MainWindow::on_l2_15_textChanged(const QString &text)
{
...
void MainWindow::on_checkBox_2_clicked() { updatePlatformSelection("Instagram", ui->checkBox_2); }
void MainWindow::on_checkBox_clicked()   { updatePlatformSelection("Tiktok", ui->checkBox); }
void MainWindow::on_checkBox_3_clicked() { updatePlatformSelection("Youtube", ui->checkBox_3); }
void MainWindow::on_checkBox_6_clicked() { updatePlatformSelection("Autres", ui->checkBox_6); }
...
void MainWindow::resetPlatformSelection()
{
...
void MainWindow::updatePlatformSelection(const QString &platform, QCheckBox *trigger)
{
    if (!ui)
        return;
...
QImage MainWindow::qrToImage(const QrCode &qr, int scale, int border)
{
...
// ---------------------- calendrier ----------------------
void MainWindow::on_pb_calendar_clicked()
{
    QDialog *dialog = new QDialog(this);
