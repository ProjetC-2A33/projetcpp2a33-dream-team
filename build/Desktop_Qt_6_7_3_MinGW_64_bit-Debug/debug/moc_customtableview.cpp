...
struct qt_meta_stringdata_CLASSCustomTableViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCustomTableViewENDCLASS = QtMocHelpers::stringData(
    "CustomTableView"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCustomTableViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CustomTableView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCustomTableViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCustomTableViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomTableViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomTableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCustomTableViewENDCLASS.stringdata0))
